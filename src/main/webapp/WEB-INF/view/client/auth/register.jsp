                                                ...
                                                <form:form method="post" action="/register" modelAttribute="registerUser">
                                                 ...
                                                 <c:set var="errorEmail">
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-md-6">
                                                            <div class="form-floating mb-3 mb-md-0">
                                                               <form:input  path="fisrtName" class="form-control" id="inputFirstName"
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-md-6">
                                                            <div class="form-floating mb-3 mb-md-0">
                                                               <form:input  path="password" class="form-control ${not empty errorPassword ? 'is-invalid' : ''}" id="inputPassword"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-floating mb-3 mb-md-0">
                                                               <form:input  path="confirmPassword" class="form-control" id="inputPasswordConfirm"
